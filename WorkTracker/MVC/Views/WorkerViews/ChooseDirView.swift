...
final class ChooseDirView: UIView {
    ...
    var firstDirector:UIButton = {
        ...
        button.setTitle("Директор Боб", for: .normal)
    ...
    var secondDirector:UIButton = {
        ...
        button.backgroundColor = .black
        button.tintColor = .red
        button.setTitle("Директор Том", for: .normal)
        button.titleLabel?.font = UIFont(name: "Vetrino", size: 22)
        button.layer.shadowOffset = CGSize(width: 2, height: 2)
        button.layer.shadowColor = UIColor.white.cgColor
        button.layer.shadowOpacity = 0.7
    ...
    var thirdDirector:UIButton = {
        ...
        button.backgroundColor = .black
        button.tintColor = .red
        button.setTitle("Директор Джек", for: .normal)
        button.titleLabel?.font = UIFont(name: "Vetrino", size: 22)
        button.layer.shadowOffset = CGSize(width: 2, height: 2)
        button.layer.shadowColor = UIColor.white.cgColor
        button.layer.shadowOpacity = 0.7
    ...
    var fourthDirector:UIButton = {
        ...
        button.backgroundColor = .black
        button.tintColor = .red
        button.setTitle("Директор Пупсень", for: .normal)
        button.titleLabel?.font = UIFont(name: "Vetrino", size: 22)
        button.layer.shadowOffset = CGSize(width: 2, height: 2)
        button.layer.shadowColor = UIColor.white.cgColor
        button.layer.shadowOpacity = 0.7
